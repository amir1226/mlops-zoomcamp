...
def main_flow_markdown(
    ...
    # Train
    train_best_model_markdown(X_train, X_val, y_train, y_val, dv)


@flow
def example_email_send_message_flow(email_addresses: list):
    email_server_credentials = EmailServerCredentials.load("my-email-credentials")
    for email_address in email_addresses:
        subject = email_send_message.with_options(name=f"email {email_address}").submit(
            email_server_credentials=email_server_credentials,
            subject="Prefect Email Test",
